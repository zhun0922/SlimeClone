...
public class EnemyAttack : MonoBehaviour
{
    ...
    void Fire()
    {
        ...
        {
            GameObject bulletObjR = Instantiate(buletObj_B, transform.position + Vector3.right * 0.3f, transform.rotation);
            GameObject bulletObjL = Instantiate(buletObj_B, transform.position + Vector3.left * 0.3f, transform.rotation);
